...
namespace fredapi.Model.Historical.MatchTimelinedelta
{
    // Root response
    public class MatchTimelinedeltaResponse
    {
        [JsonPropertyName("queryUrl")]
        public string QueryUrl { get; set; }
        
        [JsonPropertyName("doc")]
        public List<MatchTimelinedeltaDoc> Doc { get; set; }
    }

    public class MatchTimelinedeltaDoc
    {
        [JsonPropertyName("event")]
        public string Event { get; set; }
        
        // Extra property present in this JSON response.
        [JsonPropertyName("_synced")]
        ...
        public MatchTimelinedeltaData Data { get; set; }
    }

    public class MatchTimelinedeltaData
    {
        [JsonPropertyName("match")]
        public Match Match { get; set; }
        
        // The events array is empty in the sample.
        [JsonPropertyName("events")]
        public List<MatchTimelinedeltaEvent> Events { get; set; }
    }

    // Placeholder for timeline delta events.
    public class MatchTimelinedeltaEvent
    {
        // Add properties as needed when the event structure is known.
    }

    // ----------------------------
    // Below classes model the "match" object.
    // These are similar to those used for other match endpoints.
    // ----------------------------
    ...
    public class RoundName
    {
        ...
        // In the sample, "name" is a number (25); change type if needed.
