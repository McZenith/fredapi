...
namespace fredapi.Model.Historical.StatsTeamLastxExtendedResponse
{
    public class StatsTeamLastxExtendedResponse
    {
    ...
    public class Periods
    {
        ...
        // Optional property (e.g. for overtime)
        [JsonPropertyName("ot")]
    ...
    // Tournament and UniqueTournament classes (as in other responses)
