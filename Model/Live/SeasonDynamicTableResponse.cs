...
namespace fredapi.Model.Historical.SeasonDynamicTableResponse
{
    public class SeasonDynamicTableResponse
    {
    ...
    public class Data
    {
        ...
        // The "tables" array holds the main league table data.
        [JsonPropertyName("tables")]
        public List<Table> Tables { get; set; }

        // "livetables" usually has a similar structure to "tables"
        [JsonPropertyName("livetables")]
        public List<Table> LiveTables { get; set; }

        [JsonPropertyName("livematchids")]
        public List<long> LiveMatchIds { get; set; }

        [JsonPropertyName("liveteamids")]
        public List<int> LiveTeamIds { get; set; }
    }
    ...
    public class Season
    {
        ...
        // In this model the season object also includes an array of tables.
        [JsonPropertyName("tables")]
        public List<Table> Tables { get; set; }
    }
    ...
    // Represents either a regular table or a livescore table.
    public class Table
    {
        [JsonPropertyName("_doc")]
        public string Doc { get; set; }  // e.g. "statistics_leaguetable" or "livescore_leaguetable"
    ...
    {
        [JsonPropertyName("_doc")]
        public string Doc { get; set; }  // e.g. "tablerow"
    ...
    {
        [JsonPropertyName("_doc")]
        public string Doc { get; set; }  // e.g. "promotion"
    ...
    public class Comments
    {
        ...
        public Dictionary<string, TableComment> Table { get; set; }
    }
