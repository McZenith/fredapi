...
namespace fredapi.Model.Live.MatchTimelineDeltaResponse
{
    // Root class for the match_timelinedelta response.
    ...
    public class MatchTimelineDeltaDoc
    {
        ...
        // This property indicates whether the data is synced.
    ...
    public class MatchTimelineDeltaData
    {
        ...
        public List<DeltaEvent> Events { get; set; }
    }

    #region Common Match Information
    ...
    public class Match
    {
        ...
        // The "periods" structure is not specified so using object.
    ...
    public class Time
    {
        ...
        // Using TimeValue to avoid conflict with System.Time.
    ...
    public class RoundName
    {
        ...
        // In this sample the "name" is numeric.
